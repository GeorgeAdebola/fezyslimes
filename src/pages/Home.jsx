...
const IconSnapchat = ({ className = 'w-4 h-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12.017 0C8.396 0 6.14 1.867 6.14 5.22v.816c-.824.142-1.537.416-2.084.816-.547.4-.824.93-.824 1.59 0 .37.099.74.298 1.042.199.302.497.537.857.7-.182.302-.31.615-.31.87 0 .31.1.615.31.87-.2.14-.41.35-.61.62-.49.648-1.39 1.89-1.39 3.11 0 .553.253 1.028.715 1.364.355.257.844.43 1.49.526.128.256.253.526.353.796-.162.128-.335.3-.335.526 0 .443.443.777 1.195.777.54 0 1.1-.138 1.7-.257.49-.097 1.037-.193 1.48-.193.6 0 1.195.299 1.786.847.6.547 1.24.94 2.18.94.937 0 1.574-.39 2.18-.94.584-.547 1.184-.847 1.787-.847.44 0 .99.096 1.48.193.6.119 1.15.257 1.695.257.757 0 1.196-.334 1.196-.777 0-.226-.173-.399-.335-.526.099-.27.224-.54.353-.797.643-.097 1.132-.27 1.487-.526.463-.336.716-.81.716-1.364 0-1.22-.903-2.46-1.39-3.11-.198-.27-.41-.48-.61-.62.2-.256.31-.56.31-.87 0-.256-.127-.568-.31-.87.36-.163.66-.398.858-.7.198-.302.297-.672.297-1.042 0-.66-.277-1.19-.824-1.59-.548-.4-1.261-.674-2.085-.816V5.22C17.877 1.867 15.62 0 12.017 0z" />
  </svg>
);
      ...
      <footer className="bg-white/80 backdrop-blur-lg border-t border-slate-200 pt-16 pb-8 relative z-10 mt-auto">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 text-left">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <a href="https://instagram.com/fezyslimes" target="_blank" rel="noreferrer" className="text-sm text-slate-500 hover:text-pink-500 transition-colors font-bold flex items-center gap-2.5 group">
                <span className="group-hover:scale-110 transition-transform"><IconInstagram className="w-4 h-4" /></span>
                Instagram - @fezyslimes
              </a>
              <a href="https://tiktok.com/@Fezyslimes" target="_blank" rel="noreferrer" className="text-sm text-slate-500 hover:text-slate-900 transition-colors font-bold flex items-center gap-2.5 group">
                <span className="group-hover:scale-110 transition-transform"><IconTikTok className="w-4 h-4" /></span>
                TikTok - @Fezyslimes
              </a>
              <a href="https://snapchat.com/add/fezyslimes.ng" target="_blank" rel="noreferrer" className="text-sm text-slate-500 hover:text-yellow-500 transition-colors font-bold flex items-center gap-2.5 group">
                <span className="group-hover:scale-110 transition-transform"><IconSnapchat className="w-4 h-4" /></span>
                Snapchat - fezyslimes.ng
              </a>
              <a href="https://wa.me/2349155577753" target="_blank" rel="noreferrer" className="text-sm text-slate-500 hover:text-green-500 transition-colors font-bold flex items-center gap-2.5 group">
                <span className="group-hover:scale-110 transition-transform"><IconWhatsApp className="w-4 h-4 text-green-500" /></span>
                WhatsApp Us
              </a>
            </div>
          </div>
